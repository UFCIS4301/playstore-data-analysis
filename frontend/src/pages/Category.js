			...
			<div className="trendanalysis">
				<Card sx={{ maxWidth: '100%', border: 0, boxShadow: 10 }}>
					<CardContent>
						...
						<Typography variant="h6" color="text.secondary">
							This query allow us to present the number of app launches that occurred in a year or across
							multiple years. This would provide insight into the app launch pattern over time. For
							example, we may see which category had the most apps released on the Play Store in 2015
							against how the same category is performing currently.
						</Typography>
					</CardContent>
				</Card>
			</div>
