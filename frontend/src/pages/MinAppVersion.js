			...
			<div className="trendanalysis">
				<Card sx={{ maxWidth: '100%', border: 0, boxShadow: 10 }}>
					<CardContent>
						...
						<Typography variant="h6" color="text.secondary">
							Using the minimum version information and number of downloads from the data, this query
							demonstrates trend of how the Android versions influenced the category and application
							reach. An Android application, for example, that assumes a minimum SDK (Software development
							Kit) version of 16 will support a greater number of devices than SDK version 21. .
						</Typography>
					</CardContent>
				</Card>
			</div>
