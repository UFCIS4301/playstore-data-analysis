			...
			<div className="trendanalysis">
				<Card sx={{ maxWidth: '100%', border: 0, boxShadow: 10 }}>
					<CardContent>
						...
						<Typography variant="h6" color="text.secondary">
							Based on the app's release date and it’s size, this query displays average application size
							and number of applications published in the given year. This also shows how the application
							sizes have varied over the years as the number of app launches grow.
						</Typography>
					</CardContent>
				</Card>
			</div>
