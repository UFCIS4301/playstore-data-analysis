      ...
      <div className="trendanalysis">
        <Card sx={{ maxWidth: '100%', border: 0, boxShadow: 10 }}>
          <CardContent>
            ...
            <Typography variant="h6" color="text.secondary">
              This query provides us with a trend of how many free vs paid apps have been released
              over time, as well as the average price of purchased apps. Assume 100 thousand apps
              were released in 2017, and we want to demonstrate the trend of how many were free, how
              many were paid, and what the average cost of an app was that year, and how these
