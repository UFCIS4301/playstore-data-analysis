      ...
      <div className="trendanalysis">
        <Card sx={{ maxWidth: '100%', border: 0, boxShadow: 10 }}>
          <CardContent>
            ...
            <Typography variant="h6" color="text.secondary">
              We can analyse the amount of apps targeted to various age groups over time. For
              example, we can understand how many applications were published for each age group in
              a particular year.
            </Typography>
          </CardContent>
        </Card>
